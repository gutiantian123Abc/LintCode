...
> **情报卡**:至此**第四次独立出现**——#20/#21(26 NG 管线)+ 细节最全的那条新面经(三个 API、要 schema、要 body/response、追问 failure 与 consistency)+ **prachub 收录的官方化标题 "Design Game Credit System with Add/Spend/Refund APIs",难度标 Medium**。面经原话:**"总体来说不算太复杂"**——NG 级 scope,单服务 + 单库就是正确答案,别过度设计。
